...
import { superAdminPermissions } from '../../../../../helpers/permissions.js'

export default class InitializeController extends Controller{
    constructor(){
        super();
        (this.model = {User,Otp , Role}) , 
        (this.helper = {superAdminPermissions ,response , axios , validatePassword , hashPassword , otpGenerate , sendOtp ,configVerify , configToken })
    }
}
